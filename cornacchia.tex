...
\cols{Sia $(a,b)$ una soluzione ottenuta con quel metodo: allora
  ...
  minima dell'equaz. $x^2 - qy^2 = 1$, sarà certamente $2ab < \beta m$
  (almeno per $\beta > 1$); cioè, per quanto sappiamo, $(a,b)$ è la
  soluzione minima della~\eqref{quadform}. --- Similmente dicasi per
  l'equaz. $x^2 - qy^2 = -m$. Perciò, se il metodo delle divisioni
  successive dà una soluzione dell'equazione $x^2 - qy^2 = \pm m$,
  essa è necessariamente la minima (relativamente, s'intende, alla
  radice della congruenza $x^2 - q \equiv 0 \mod m$, che si
  considera).
